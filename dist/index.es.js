...
const I = {
  ...
  return { state: b, ZhuanpanStatus: O, ZhuanpanPosition: I, setOptions: s, play: r, reset: u, onPanEnd: () => {
    y.useElementEvent && f && (f(g), f = null, g = null, m());
  } };
}, z = (p) => {
  const y = Y(!0), S = window.requestAnimationFrame, b = window.cancelAnimationFrame;
  return { rafReadyStatus: y, raf: S, cancelRaf: b, onRafReady: (s) => S(s) };
}, ot = (p, ...y) => {
  console.warn("FanUse:", p, ...y);
}, gt = (p) => {
  const { initialValue: y, canvasSelector: S, mp: b, ...d } = p || {}, { raf: s, cancelRaf: o } = z(), t = {
    duration: 800,
    interval: 20,
    minStep: 1,
    decimal: 0
  ...
  e(d);
  let u = 0, f = 0, g = 0, m = 0, r = null;
  const i = () => {
    r && (o(r), r = null);
  }, a = () => {
    i(), r = s(() => {
      r = null;
      const x = Date.now(), _ = n.value, A = Math.ceil((x - u) / t.interval);
    ...
    T !== n.value && (e(A), f = n.value, g = T, u = Date.now(), m = (g - n.value) / Math.ceil(t.duration / t.interval), m = m < 0 ? Math.min(-Math.abs(t.minStep), m) : Math.max(Math.abs(t.minStep), m), a());
  };
  return Z(() => i()), { countValue: n, countTo: C };
}, ht = (p) => {
  const { canvasSelector: y, mp: S, ...b } = p || {}, { raf: d, cancelRaf: s } = z(), o = {
    time: 0,
    millisecond: !1
  }, t = (x) => {
    Object.assign(o, x);
  ...
  const e = K({
    ...
    M -= R * D;
    const q = Math.floor(M / j);
    M -= j * q;
    const F = Math.floor(M / L);
    M -= L * F;
    const k = Math.floor(M / T), H = M - T * k;
    Object.assign(e, { time: M, days: D, hours: q, minutes: F, seconds: k, milliseconds: H }), !_ && o.onChange && o.onChange({ ...e });
  };
  u(o.time, !0);
  let f = 0, g = null;
  const m = () => {
    ...
    g = d(() => {
      g = null, u(o.time - (Date.now() - f)), e.time > 0 ? r() : o.onFinish && o.onFinish();
    });
  }, i = () => {
    f || (f = Date.now(), r());
  }, a = () => {
    ...
    a(), f = 0, t({ time: typeof (x == null ? void 0 : x.time) > "u" ? n : x.time, ...x }), n = o.time, u(o.time);
  };
    ...
    return (
      ...
      function() {
        var S = {
          ...
          686: (
            ...
            function(s, o, t) {
              ...
              var n = t(279), e = /* @__PURE__ */ t.n(n), u = t(370), f = /* @__PURE__ */ t.n(u), g = t(817), m = /* @__PURE__ */ t.n(g);
              function r(w) {
                try {
              ...
              var tt = /* @__PURE__ */ function(w) {
                ...
                return q(c, [{
                  ...
                  key: "onClick",
                  value: function(v) {
                    var E = v.delegateTarget || v.currentTarget, P = this.action(E) || "copy", $ = j({
                      action: P,
                      container: this.container,
                      target: this.target(E),
                      text: this.text(E)
                    });
                    this.emit($ ? "success" : "error", {
                      action: P,
                      text: $,
                      trigger: E,
                  ...
                  value: function() {
                    ...
                    return E.forEach(function($) {
                      P = P && !!document.queryCommandSupported($);
                    }), P;
                  }
                }]), c;
              }(e()), et = tt;
          ...
          828: (
            ...
            function(s) {
              ...
              function n(e, u) {
                for (; e && e.nodeType !== o; ) {
                  if (typeof e.matches == "function" && e.matches(u))
                    return e;
                  e = e.parentNode;
                }
              }
            ...
            function(s) {
              function o(t) {
                ...
                if (t.nodeName === "SELECT")
                  ...
                  f.selectNodeContents(t), u.removeAllRanges(), u.addRange(f), n = u.toString();
                }
                return n;
              }
              s.exports = o;
            ...
            function(s) {
              ...
              o.prototype = {
                ...
                once: function(t, n, e) {
                  var u = this;
                  function f() {
                    u.off(t, f), n.apply(e, arguments);
                  }
                  return f._ = n, this.on(t, f, e);
                },
                emit: function(t) {
                  var n = [].slice.call(arguments, 1), e = ((this.e || (this.e = {}))[t] || []).slice(), u = 0, f = e.length;
                  for (u; u < f; u++)
                    e[u].fn.apply(e[u].ctx, n);
                  return this;
                },
                off: function(t, n) {
                  var e = this.e || (this.e = {}), u = e[t], f = [];
                  if (u && n)
                    for (var g = 0, m = u.length; g < m; g++)
                      u[g].fn !== n && u[g].fn._ !== n && f.push(u[g]);
        ...
        function d(s) {
          ...
          return S[s](o, o.exports, d), o.exports;
        }
        return function() {
          d.n = function(s) {
          ...
          d.d = function(s, o) {
            for (var t in o)
              d.o(o, t) && !d.o(s, t) && Object.defineProperty(s, t, { enumerable: !0, get: o[t] });
          };
        }(), function() {
          d.o = function(s, o) {
...
const at = () => {
  ...
  if (y)
    for (let s in y)
      d.setAttribute(s, y[s]);
  d.src = p, d.onload = S, d.onerror = (s) => {
    document.head.removeChild(d), b(s);
  }, document.head.appendChild(d);
}), ut = () => new Promise(() => null), vt = (p) => {
  const { timeout: y, requestInterceptor: S, responseInterceptor: b, customCodeSet: d, errorInterceptor: s } = p || {}, o = nt.create({
    timeout: y || 6e4,
    // withCredentials: true, // send cookies when cross-domain requests
    validateStatus: () => !0
  }), t = (n) => typeof s == "function" ? Promise.reject(s(n)) : Promise.reject(n);
  return o.interceptors.request.use(
    async (n) => {
      ...
      const u = ["get", "delete"];
      return (!e.method || u.includes(e.method.toLowerCase()) && e.data && !e.params) && (e.params = e.data), e;
    },
    (n) => {
    ...
    async (n) => {
      const { config: e, data: u, status: f, headers: g } = n, { rejectErrorCode: m } = e;
      if (f > 299) {
        let i = "";
        return d != null && d.messageKey && u && typeof u == "object" && (i = u[d.messageKey]), i || (i = `${f > 499 ? "服务忙" : "内部错误"}，请稍候重试...`), t(new N({ message: i, status: f, config: e }));
      }
      let r = u;
      if (typeof b == "function") {
        let i = b({ data: u, status: f, config: e, headers: g });
        if (J(i))
          try {
            i = await i;
          } catch (a) {
      ...
      if (m !== !1 && d) {
        ...
        if (Array.isArray(d.okValue) ? a = d.okValue.includes(i) : a = i === d.okValue, !a)
          return t(
            new N({ message: r[d.messageKey], status: f, customCode: i, config: e })
          );
      }
      return r;
    },
    (n) => {
      ...
      if (((g = n.request) == null ? void 0 : g.status) === 0)
        return ut();
      const { status: e, data: u } = n.response || {};
      let f;
      return u && (d != null && d.messageKey) && (f = u[d.messageKey]), t(new N({ message: n.message, status: e, customCode: f, config: n.config }));
    }
  ), { request: o };
}, ct = "fanWxJsSdk", lt = "//res.wx.qq.com/open/js/jweixin-1.6.0.js", ft = (p) => {
  const { configGetter: y, sdkLoadedUrl: S } = p || {};
  let b = "";
  const { isWeixin: d, isIos: s } = at(), o = /* @__PURE__ */ new Map(), t = (m, r) => {
    const i = o.get(m) || [];
    i.push(r), o.set(m, i);
  }, n = (m) => {
    if (!W)
  ...
  return { configWeixinJs: async (m) => {
    ...
    _ && (window.wx.config(C), await u()), b = i, x && (window.wx.updateTimelineShareData(x), window.wx.updateAppMessageShareData(x)), e(i);
...
}, wt = (p) => W ? (window.fanWeixinSdk || (window.fanWeixinSdk = ft(p)), window.fanWeixinSdk) : {}, bt = () => {
  let p;
  const y = (d, s, o) => {
    let t = `${s.top || 0}px ${s.right || 0}px ${s.bottom || 0}px ${s.right || 0}px`;
    p = new IntersectionObserver(
      (n) => {
        n.forEach((e) => {
          var u;
          e.isIntersecting && s.callback && s.callback({ ...(u = e.target) == null ? void 0 : u.dataset });
        });
      },
      { root: o, rootMargin: t }
  ...
  return { observer: async (d) => {
    let s;
    d.root && (s = document.querySelectorAll(d.root)[0]);
