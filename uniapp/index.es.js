...
const j = {
  ...
  const E = () => {
    ...
    f.panStyle = `transition:transform ${p.duration}ms;transform:rotate(${_}deg)`, f.panStyleSlowly !== "" && setTimeout(() => {
      f.panStyleSlowly = "";
    }, p.duration / 2), p.useElementEvent ? (c = x, v = s) : setTimeout(() => {
      x(s), E();
    }, p.duration);
  });
  return { state: f, ZhuanpanStatus: R, ZhuanpanPosition: j, setOptions: d, play: l, reset: e, onPanEnd: () => {
    p.useElementEvent && c && (c(v), c = null, v = null, E());
  } };
}, G = (u, ...p) => {
  ...
  const m = () => {
    ...
    m(), l = d(() => {
      ...
      let C = Number((c + E * A).toFixed(t.decimal));
    ...
    C !== r.value && (n(A), c = r.value, v = C, e = Date.now(), E = (v - r.value) / Math.ceil(t.duration / t.interval), E = E < 0 ? Math.min(-Math.abs(t.minStep), E) : Math.max(Math.abs(t.minStep), E), s());
  };
  ...
  const E = () => {
    ...
    v = S(() => {
      v = null, e(a.time - (Date.now() - c)), n.time > 0 ? l() : a.onFinish && a.onFinish();
    });
  }, m = () => {
    c || (c = Date.now(), l());
  }, s = () => {
    ...
    s(), c = 0, t({ time: typeof (T == null ? void 0 : T.time) > "u" ? r : T.time, ...T }), r = a.time, e(a.time);
  };
        ...
        var b = {
          ...
          686: (
            ...
            function(d, a, t) {
              ...
              var r = t(279), n = /* @__PURE__ */ t.n(r), e = t(370), c = /* @__PURE__ */ t.n(e), v = t(817), E = /* @__PURE__ */ t.n(v);
              function l(g) {
                try {
              ...
              var T = function(i, o) {
                ...
                var h = E()(y);
                return l("copy"), y.remove(), h;
              }, _ = function(i) {
                var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
                  container: document.body
                }, y = "";
                return typeof i == "string" ? y = T(i, o) : i instanceof HTMLInputElement && !["text", "search", "url", "tel", "password"].includes(i == null ? void 0 : i.type) ? y = T(i.value, o) : (y = E()(i), l("copy")), y;
              }, A = _;
              function C(g) {
              ...
              var et = /* @__PURE__ */ function(g) {
                ...
                return F(o, [{
                  ...
                  value: function(h) {
                    var w = this;
                    this.listener = c()(h, "click", function(O) {
                      return w.onClick(O);
                    });
                  }
                  /**
          ...
          438: (
            ...
            function(d, a, t) {
              var r = t(828);
              function n(v, E, l, m, s) {
                var x = c.apply(this, arguments);
                return v.addEventListener(l, x, s), {
                  destroy: function() {
                    v.removeEventListener(l, x, s);
                  }
                };
              }
              function e(v, E, l, m, s) {
                return typeof v.addEventListener == "function" ? n.apply(null, arguments) : typeof l == "function" ? n.bind(null, document).apply(null, arguments) : (typeof v == "string" && (v = document.querySelectorAll(v)), Array.prototype.map.call(v, function(x) {
                  return n(x, E, l, m, s);
                }));
              }
              function c(v, E, l, m) {
          ...
          370: (
            ...
            function(d, a, t) {
              ...
              function v(l, m, s) {
                return Array.prototype.forEach.call(l, function(x) {
            ...
            function(d) {
              function a(t) {
                ...
                if (t.nodeName === "SELECT")
                  ...
                  var e = window.getSelection(), c = document.createRange();
                  c.selectNodeContents(t), e.removeAllRanges(), e.addRange(c), r = e.toString();
                }
                return r;
              }
              d.exports = a;
            ...
            function(d) {
              ...
              a.prototype = {
                ...
                once: function(t, r, n) {
                  var e = this;
                  function c() {
                    e.off(t, c), r.apply(n, arguments);
                  }
                  return c._ = r, this.on(t, c, n);
                },
                emit: function(t) {
                  var r = [].slice.call(arguments, 1), n = ((this.e || (this.e = {}))[t] || []).slice(), e = 0, c = n.length;
                  for (e; e < c; e++)
                    n[e].fn.apply(n[e].ctx, r);
                  return this;
                },
                off: function(t, r) {
                  var n = this.e || (this.e = {}), e = n[t], c = [];
                  if (e && r)
                    for (var v = 0, E = e.length; v < E; v++)
                      e[v].fn !== r && e[v].fn._ !== r && c.push(e[v]);
                  return c.length ? n[t] = c : delete n[t], this;
                }
...
const ft = (u) => {
  ...
  return { request: async (t) => {
    ...
    try {
      const n = await uni.request(r), { data: e, statusCode: c, header: v } = n, { rejectErrorCode: E } = r;
      if (c > 299) {
        let m = "";
        throw S != null && S.messageKey && e && typeof e == "object" && (m = e[S.messageKey]), m || (m = `${c > 499 ? "服务忙" : "内部错误"}，请稍候重试...`), new U({ message: m, status: c, config: r });
      }
      let l = e;
      if (typeof f == "function") {
        let m = f({ data: e, status: c, config: t, headers: v });
        if (Y(m))
          try {
            m = await m;
          } catch (s) {
            throw new U({ message: s.message || "系统开小差了", status: c, config: r });
          }
        typeof m < "u" && (l = m);
      }
      ...
      if (E !== !1 && S) {
        ...
        if (Array.isArray(S.okValue) ? s = S.okValue.includes(m) : s = m === S.okValue, !s)
          throw new U({ message: e[S.messageKey], status: c, customCode: m, config: r });
      }
      return l;
    } catch (n) {
      const e = new U({
